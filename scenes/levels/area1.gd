...
var arrangement_base: PackedScene = preload("res://scenes/levels/arrangement_base.tscn")



#selection of which arrangement to load
var layout_options := [arrangement_1, arrangement_2, arrangement_3]
var selected_arrangement = arrangement_base #layout_options[randi()%len(layout_options)]
